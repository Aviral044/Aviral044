...
- ⚙️ Backend + distributed systems enthusiast
...
Frontend: React.js  
Cloud/DevOps: AWS, Docker, Kubernetes, Helm, CI/CD  
...
- Cloud infrastructure that scales up, scales down, and behaves itself
...
- Graph analytics
- Better ways to make microservices less dramatic

## 📫 Find Me Around the Internet

- LinkedIn: https://linkedin.com/in/aviral-gupta-sde/
- Email: agupt467@asu.edu
---

> "It works on my machine"  
> — famous last words before Docker entered the chat
